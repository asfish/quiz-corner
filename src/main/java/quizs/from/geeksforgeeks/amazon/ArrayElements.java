 ...
 * For every quadruple (a, b, c, d), check if (a+b) = (c+d). Time complexity of this solution is O(n4).
 *
 * An Efficient Solution can solve this problem in O(n2) time. The idea is to use hashing. We use
